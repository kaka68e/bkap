...
class OrderSearch extends Order
{
    ...
    public function rules()
    {
        ...
        return [
            [['order_id', 'id_customer', 'total', 'status', 'created_at'], 'integer'],
            [['customer_name', 'mobile', 'address', 'email', 'customer_ship', 'mobile_ship', 'address_ship', 'email_ship', 'request', 'id_payment', 'id_deliver', 'date_buy_created', 'date_buy_updated'], 'safe'],
        ];
    }
    ...
    {
        $query = Order::find()->orderBy(['order_id'=>SORT_DESC]);
        ...
        $query->andFilterWhere([
            ...
            'date_buy_created' => $this->date_buy_created,
            'date_buy_updated' => $this->date_buy_updated,
        ]);
