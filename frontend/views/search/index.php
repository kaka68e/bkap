...
$this->title = "Tìm kiếm: ".Yii::$app->request->get('string');
...
<article class="col-main" style="width: 100%;">
	...
	<h2 class="page-heading" style="font-weight: 600;color:#3498db"> <span class="page-heading-title">Tìm kiếm: <?php echo Yii::$app->request->get('string') ?></span> </h2>
