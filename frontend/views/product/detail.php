...
// echo '<pre>';
// var_dump($random6ProductByCategory);
?>
							...
							<div class="product-image">
								<div class="product-full">
									...
									<div style="margin-top:8px">
										...
										<?php echo Html::a(
											'<button class="button" type="button" title=""><span>Về trang chủ</span></button>',
											['/']
											); ?>	
									</div>
						...
						<div class="product-shop col-lg-8 col-sm-7 col-xs-12">
							<div class="product-next-prev"> 
								<a class="product-next" href="#"><span></span></a>
							 	...
							 	<?php //echo Html::a('Về trang chủ',['/site/index'],['class'=>'']) ?>
							</div>
							...
							<div class="short-description">
								<h2>Danh mục: <?php echo $category_name1 ?></h2>
							</div>
							<!-- <div class="ratings">
								...
								<div class="add-to-cart">
									<!-- <div class="pull-left">
										<div class="custom pull-left">
											<button onClick="var result = document.getElementById('qty'); var qty = result.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 0 ) result.value--;return false;" class="reduced items-count" type="button"><i class="fa fa-minus">&nbsp;</i>
											</button>
											<input type="text" class="input-text qty" title="Qty" value="1" maxlength="12" id="qty" name="qty">
											<button onClick="var result = document.getElementById('qty'); var qty = result.value; if( !isNaN( qty )) result.value++;return false;" class="increase items-count" type="button"><i class="fa fa-plus">&nbsp;</i>
											</button>
										</div>
									</div> -->
									...
									<div>
										<?php echo Html::a(
											'<button class="button btn-cart" type="button" title="" data-original-title="Add to Cart"><span>Thêm vào giỏ</span></button>',
											['/cart/add-cart','id' => $productDetail[0]['product_id']],
											[
											'class' => 'add-cart1',
											'product_name' => $productDetail[0]['product_name'],
											'product_image' => $productDetail[0]['image']
											]
											); ?>
									</div>
										...
										<ul class="add-to-links">
											<?php if(!Yii::$app->user->isGuest): ?>
												<li>
													...
													<a class="link-wishlist" product-name1 = '<?= $productDetail[0]['product_name']?>' data-dar ="<?= $productDetail[0]['product_id'] ?>" data-href="<?php echo Yii::$app->homeUrl ?>wishlist/add"></a> 
												</li>
											<?php endif; ?>
										</ul>
									</div>
				...
				<div class="product-collateral col-lg-12 col-sm-12 col-xs-12">
					...
					<div class="add_info">
						...
						<ul id="product-detail-tab" class="nav nav-tabs product-tabs">
							<li class="active"> <a href="#product_tabs_description" data-toggle="tab">Miêu tả chỉ tiết</a> </li>
						...
						<div id="productTabContent" class="tab-content">
							...
							<div class="tab-pane fade in active" id="product_tabs_description">
								<div class="std">
									<?php echo $productDetail[0]['meta_description'] ?>
								</div>
							</div>
				...
				<div id="related-products-slider" class="product-flexslider hidden-buttons">
					<div class="home-block-inner">
						...
						<div class="block-title">
							<h2 style="line-height: 135%;">Sản phẩm<br>
								<em>tương tự</em></h2>
							</div>
							<div class="pretext">Có thể bạn sẽ quan tâm những sản phẩm này: <br>
							Danh mục: abc
							</div>
							<!-- <a href="grid.html" class="view_more_bnt">Xem tất cả</a>   -->
						</div>

						<div class="slider-items slider-width-col4 products-grid block-content">
							
							<?php 
							foreach ($random6ProductByCategory as $item) :
							?>
								...
								<div class="item-inner">
									<div class="item-img">
										<div class="item-img-info">
											...
											<?php 
											echo Html::a(
												'<img src="'.Yii::$app->homeUrl.$item['image'].'"" alt="'.$item['product_name'].'"">',
												['product/detail','slug'=>$item['product_slug']],
												['class'=>'product-image']
											);
											 ?>
											...
											<div class="box-hover">
												<ul class="add-to-links">
													<li style="visibility: hidden;"><a class="link-wishlist" href="wishlist.html">Yêu thích</a>
													</li>
													<li>
														<?= Html::a('Xem chi tiết',
															['product/detail','slug'=>$item['product_slug']],
													...
													<?php if (!Yii::$app->user->isGuest) : ?>
													<li>
														<a class="link-wishlist" product-name1 = '<?= $item['product_name']?>' data-dar ="<?= $item['product_id'] ?>" data-href="<?php echo Yii::$app->homeUrl ?>wishlist/add">Yêu thích</a> 
									...
									<div class="item-info">
										<div class="info-inner">
											<div class="item-title">
											 <?= Html::a($item['product_name'],
												['product/detail','slug'=>$item['product_slug']],
												['class'=>'link-quickview','title'=>$item['product_name']]
											) ?>
											</div>
											<div class="rating">
												<div class="ratings">
											...
											<div class="item-content">
												<div class="item-price">
													<div class="price-box"><span class="regular-price"><span class="price">Đ <?php echo number_format($item['price_real']) ?></span> </span> </div>
												</div>
												<div class="action">
													<?php echo Html::a('<button class="button btn-cart" type="button" title="" data-original-title="Add to Cart"><span>Thêm vào giỏ hàng</span></button>',
														['/cart/add-cart','id' => $item['product_id']],
														[
														'class' => 'add-cart1',
