							...
							<thead>
								...
								<tbody>
									...
									<tr class="first odd">
										...
										<?php $form = ActiveForm::begin([
											...
											<button type="submit" name="update" id="update" class=""><i class="fa fa-refresh fa-spin fa-1x fa-fw" aria-hidden="true"></i></button>
								...
								<tr class="first last">
									<td class="a-right last" colspan="50">
										...
										<?php echo Html::a('<button id="empty_cart_button" class="button btn-empty" title="Xóa tất cả" value="" name="update_cart_action" type="button"><span>Xóa tất cả</span></button>',['/cart/remove-all']) ?>
